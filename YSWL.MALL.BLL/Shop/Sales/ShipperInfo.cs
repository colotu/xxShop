...
namespace YSWL.MALL.BLL.Shop.Sales
{
    ...
    public partial class ShipperInfo
    {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSWL.MALL.Model.Shop.Sales.ShipperInfo GetModelByCache(int ShipperId)
        {
            ...
            return (YSWL.MALL.Model.Shop.Sales.ShipperInfo)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.Shop.Sales.ShipperInfo> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.Shop.Sales.ShipperInfo> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.Shop.Sales.ShipperInfo> modelList = new List<YSWL.MALL.Model.Shop.Sales.ShipperInfo>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSWL.MALL.Model.Shop.Sales.ShipperInfo model;
