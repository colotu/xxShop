<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="ModifyNew.aspx.cs" Inherits="YSWL.MALL.Web.FriendlyLink.FLinks.ModifyNew" Title="<%$Resources:SiteSetting,ptFriendlyLinkModify %>" %>
            ...
            <tr>
                <td class="tdbg">
                    <table cellspacing="0" cellpadding="3" width="100%" border="0">
                        ...
                        <tr>
                            <td class="td_class">
                                <asp:Literal ID="Literal9" runat="server" Text="<%$Resources:SiteSetting,lblIsDisplay %>" />£º
                            </td>
                            <td>
