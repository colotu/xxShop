...
namespace YSWL.MALL.BLL.Shop.Coupon
{
	...
	public partial class CouponHistory
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.Shop.Coupon.CouponHistory GetModelByCache(string CouponCode)
		{
			...
			return (YSWL.MALL.Model.Shop.Coupon.CouponHistory)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Coupon.CouponHistory> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Coupon.CouponHistory> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.Shop.Coupon.CouponHistory> modelList = new List<YSWL.MALL.Model.Shop.Coupon.CouponHistory>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.Shop.Coupon.CouponHistory model;
