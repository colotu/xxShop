...
namespace YSWL.MALL.BLL.Shop
{
	...
	public partial class Constant
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.Shop.Constant GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			...
			return (YSWL.MALL.Model.Shop.Constant)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Constant> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Constant> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.Shop.Constant> modelList = new List<YSWL.MALL.Model.Shop.Constant>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.Shop.Constant model;
