...
namespace YSWL.MALL.BLL.Shop.Package
{
	...
	public partial class PackageCategory
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.Shop.Package.PackageCategory GetModelByCache(int CategoryId)
		{
			...
			return (YSWL.MALL.Model.Shop.Package.PackageCategory)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Package.PackageCategory> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Package.PackageCategory> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.Shop.Package.PackageCategory> modelList = new List<YSWL.MALL.Model.Shop.Package.PackageCategory>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.Shop.Package.PackageCategory model;
