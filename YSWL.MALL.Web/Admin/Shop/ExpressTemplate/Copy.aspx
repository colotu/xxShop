<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true" CodeBehind="Copy.aspx.cs" 
Inherits="YSWL.MALL.Web.Admin.Shop.ExpressTemplate.Copy" Title="新增相似快递单" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal3" runat="server" Text="新增相似快递单" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal4" runat="server" Text="您可以新增相似快递单" />
                    </td>
                </tr>
            </table>
        </div>
            ...
            <div id="flashoutput">
                <noscript>
                    <object id="flexApp" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,5,0,0" height="600" width="900">
                        ...
                        <param name="src" value="/Tools/flex/AddSimpleExpressTemplate.swf" />
                        <embed name="flexApp" pluginspage="http://www.macromedia.com/go/getflashplayer" src="/Tools/flex/AddSimpleExpressTemplate.swf" height="600" width="900" flashvars="bridgeName=example" />
                    </object>
                </noscript>
                <script language="javascript" charset="utf-8">
                    ...
                    document.write('<param name="src" value="/Tools/flex/AddSimpleExpressTemplate.swf"/>');
                    document.write('<embed name="flexApp" pluginspage="http://www.macromedia.com/go/getflashplayer" src="/Tools/flex/AddSimpleExpressTemplate.swf" height="600" width="900" flashvars="bridgeName=example"/>');
