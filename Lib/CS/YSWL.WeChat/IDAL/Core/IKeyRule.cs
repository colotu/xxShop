...
namespace YSWL.WeChat.IDAL.Core
{
	...
	public interface IKeyRule
	{
		...
		/// 增加一条数据
		/// </summary>
		int Add(YSWL.WeChat.Model.Core.KeyRule model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(YSWL.WeChat.Model.Core.KeyRule model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		YSWL.WeChat.Model.Core.KeyRule GetModel(int RuleId);
		YSWL.WeChat.Model.Core.KeyRule DataRowToModel(DataRow row);
		/// <summary>
		/// 获得数据列表
		/// </summary>
