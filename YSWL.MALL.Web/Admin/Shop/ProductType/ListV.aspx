<%@ Page Title="PMS_AttributeValues" Language="C#" MasterPageFile="~/Admin/Basic.Master"
    AutoEventWireup="true" CodeBehind="ListV.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.ProductType.ListV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="newslistabout">
        ...
        <div class="newslist mar-bt">
            <div class="newsicon">
                <ul>
                    <li class="add-btn" id="liAdd" runat="server"><a id="aAdd"> 新增属性值</a></li>
                </ul>
            </div>
        </div>
