<%@ Page Title="编辑配送方式" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true" CodeBehind="UpdateShipType.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.Shipping.UpdateShipType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">.border .ng-scope [type=text]{min-height: 5px;} input{ padding: 2px;}</style>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal1" runat="server" Text="编辑配送方式" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal6" runat="server" Text="您可以进行编辑配送方式操作" />
                    </td>
                </tr>
            </table>
        </div>
                        ...
                        <td class="tdbg">
                            <table cellspacing="0" cellpadding="3" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="tName" TabIndex="1" runat="server" Width="318px" MaxLength="20"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="<%$ Resources:Site, ErrorNotNull%>" Display="Dynamic" ControlToValidate="tName"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td_class td-class">
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="tWeight" TabIndex="2" runat="server" Width="318px" MaxLength="20" Text="0"></asp:TextBox>（克）
                                        <asp:RangeValidator ID="RangeValidator2" Display="Dynamic" Type="Integer" ControlToValidate="tWeight" MinimumValue="0" MaximumValue="10000" runat="server" ErrorMessage="数字在0-10000之间"></asp:RangeValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td_class td-class">
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="tAddWeight" TabIndex="3" runat="server" Width="318px" MaxLength="20" Text="0"></asp:TextBox>（克）
                                        <asp:RangeValidator ID="RangeValidator1" Display="Dynamic" Type="Integer" ControlToValidate="tAddWeight" MinimumValue="0" MaximumValue="10000" runat="server" ErrorMessage="数字在0-10000之间"></asp:RangeValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td_class td-class">
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="tPrice" TabIndex="2" runat="server" Width="318px" MaxLength="20" Text="0"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td_class td-class">
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="tAddPrice" TabIndex="3" runat="server" Width="318px" MaxLength="20" Text="0"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td_class td-class">
                                    ...
                                    <td height="50">
                                        <asp:TextBox ID="tDesc" runat="server" Width="314px" TextMode="MultiLine" Text=""></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <div ng-app="RegionApp"><%--style="margin-top: 20px; margin-left: 20px; margin-bottom: 20px"--%>
                                <div ng-controller="RegionCtrl">
                                    <span>您已设置 {{regions.length}} 个地区价格</span>
                                        <table id="RegionSave" style="width: 544px;" cellpadding="2" cellspacing="1" class="GridViewTyle">
                                            <tr height="25px" style="background-color: #CCCCCC; height: 25px; background: #FFF">
                                                <th scope="col" style="border: 1px solid #ddd; border-right: 0px;">
                                                    地区
                                                </th>
                                                <th scope="col" style="border: 1px solid #ddd; border-left: 0px; border-right: 0px;">
                                                    起步价
                                                </th>
                                                <th scope="col" style="border: 1px solid #ddd; border-left: 0px; border-right: 0px;">
                                                    加价
                                                </th>
                                                <th scope="col" style="border: 1px solid #ddd; border-left: 0px;">
                                                    操作
                                                </th>
                                            </tr>
                                            <tr ng-repeat="item in regions" height="27px" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#CBE3F4';" onmouseout="this.style.backgroundColor=currentcolor" style="height: 25px; background-color: rgb(255, 255, 255);  background-position: initial initial; background-repeat: initial initial;">
                                                ...
                                                <td align="center" height="27px" style="padding-left: 5px; height: 27px;">
                                                    <input type="text" ng-model="item.price" size="10" style="text-align: right;margin-top: 12px;" class="OnlyFloat" placeholder="起步价" />
                                                </td>
                                                <td align="center" height="27px" style="padding-left: 5px; height: 27px;">
                                                    <input type="text" ng-model="item.addprice" size="10" style="text-align: right;margin-top: 12px;" class="OnlyFloat" placeholder="加价" />
                                                </td>
                                                <td align="center" height="27px" style="padding-left: 5px; height: 27px;">
                                                    <input type="button" class="mar-bt ed-btn" ng-click="removeRegion(item)" value="删除" />
                                                </td>
                                            </tr>
                                        </table>
                                    <div novalidate>
                                    <div style="margin-top: 20px;">
                                        <table id="Table1" style="width: 544px;" cellpadding="2" cellspacing="1" class="GridViewTyle">
                                            <tr height="25px" style="background-color: #CCCCCC; height: 25px; background: #FFF">
                                                <th scope="col" colspan="4" style="border: 1px solid #ddd;">
                                                    新增地区价格
                                                </th>
                                            </tr>
                                            <tr height="27px" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#CBE3F4';" onmouseout="this.style.backgroundColor=currentcolor" style="height: 25px; background-color: rgb(255, 255, 255);  background-position: initial initial; background-repeat: initial initial;">
                                                <td align="center" height="27px" style="padding-left: 5px; height: 27px;">
                                                    <asp:DropDownList ID="drpRegion" runat="server" multiple="true" Width="250px" height="27px" ui-select2 ng-model="ids" Style="margin-right: 5px" />
                                                </td>
                                                <td align="center" height="27px" style="padding-left: 5px; height: 27px;">
            ...
            <table style="width: 100%; border-top: none; float: left;" cellpadding="2" cellspacing="1">
                <tr>
                    ...
                    <td height="25" style="padding-left:6px;">
                            <asp:Button ID="Button2" runat="server" CausesValidation="false" Text="<%$ Resources:Site, btnCancleText %>" OnClick="btnCancle_Click" class="adminsubmit-short add-btn mar-t10"></asp:Button>
                        <asp:Button ID="Button1" runat="server" Text="<%$ Resources:Site, btnSaveText %>" OnClick="btnSave_Click" OnClientClick="return sub()" class="adminsubmit-short add-btn mar-t10"></asp:Button>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
