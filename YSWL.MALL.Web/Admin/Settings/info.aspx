...
<script runat="server">
    ...
    {
        DataTable table = GenerateDataTable("Product Information");
        // ProductInfo
        Assign(table, "Product", YSWL.MALL.Web.MvcApplication.AssemblyProduct);
        Assign(table, "Version", YSWL.MALL.Web.MvcApplication.AssemblyVersion.ToString());
        Assign(table, "Description", YSWL.MALL.Web.MvcApplication.AssemblyDescription);
        return table;
    }
    ...
    {
        LoadInformation(GetProductInfo());
