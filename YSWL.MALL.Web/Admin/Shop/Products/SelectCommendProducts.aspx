<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/BasicNoFoot.Master" AutoEventWireup="true" CodeBehind="SelectCommendProducts.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.Products.SelectCommendProducts" %>
                ...
                <asp:panel id="Panel1" runat="server" defaultbutton="btnSearch">
                        ...
                        <div class="margtop">
                            ...
                            <asp:textbox id="txtProductNum" runat="server"  Visible="false" />
                              <asp:button id="btnSearch" OnClick="btnSearch_Click" runat="server" text="查询" cssclass="adminsubmit_short"  style="margin-right:0;" />
                         </div>
                </asp:panel>
                <div class="content margtop">
                    ...
                    <table width="100%" border="0" cellspacing="0" class="conlisttd" skuid="<%# Eval("ProductId") %>">
                      ...
                      <%--  <td width="19%" valign="top"> 库存：0<%--<%# Eval("Stock") %></td>--%>
                        ...
                        <td width="15%" valign="top"><a href="javascript:void(0);"><span  runat="server" id="lbtnAdd" class="submit_add">新增</span></a></td>
                      </tr>
                   </table>
                </itemtemplate>
                        </asp:DataList>
            ...
            <div class="right">
                ...
                <ul>
                    <li id="liDelAll" runat="server">
                        <asp:button runat="server" id="btnClear" cssclass="add-btn" text="清空列表" 
