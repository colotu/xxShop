...
;
(function () {
    var currenScript = $('[src$="maticsoft.selectgiftnode.js"]').last(); //锁定脚本引用
    ...
    function InitLastSelect() {
        ...
        $.ajax({
            ...
            timeout: 10000,
            async: false,
            data: { Action: "GetGiftParentNode", NodeId: $('[HFID=' + currentBaseSelectGuid + ']').val() },
    ...
    function LoadChildNodeData(send) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            timeout: 10000,
            data: { Action: "GetGiftChildNode", ParentId: $(send).val() },
            async: false,
            success: function (resultData) {
                switch (resultData.STATUS) {
                    case "OK":
