<%@ Page Language="C#" MasterPageFile="~/Admin/BasicNoFoot.Master" AutoEventWireup="true"
    CodeBehind="Add.aspx.cs" Inherits="YSWL.MALL.Web.CMS.VideoAlbum.Add" Title="<%$ Resources:CMSVideo, ptVideoAlbumAdd %>" %>
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td height="25">
                                ...
                                <YSWL:ValidateTarget ID="ValidateTargetName" runat="server" Description="<%$ Resources:CMSVideo, IDS_Message_AlbumName_Description %>" OkMessage="输入正确"
