...
$(function() {
    ...
    $("#txtTitle").focus(function() {
        $("#titleTip").removeClass("msg msg-ok msg-naked").removeClass("msg msg-err").addClass("msg msg-info").html("<i class=\"msg-ico\"></i><p>填写接收人积分数量</p>");
    }).blur(function() {
...
function checknickname() {
    ...
    var errnum = 0;
    $.ajax({
        url: "/UserCenter/ExistsUserNameJF",
        type: 'post',
        dataType: 'json',
        timeout: 10000,
        async: false,
