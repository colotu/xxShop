/**
* PaymentReturnTemplatedController.cs
*
* 功 能： 支付接口回调/通知抽象基类
* 类 名： PaymentReturnTemplatedController
*
...
namespace YSWL.Payment.Web
{
    ...
    [System.Obsolete]
    public abstract class PaymentReturnTemplatedController<T> : Controller where T : class, IOrderInfo
    {
        ...
        protected PaymentReturnTemplatedController(IPaymentOption<T> option, bool _isBackRequest)
        {
            this.Option = option;
        ...
        protected virtual void DoValidate()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        string sign = this.Request.Params["sign"];
