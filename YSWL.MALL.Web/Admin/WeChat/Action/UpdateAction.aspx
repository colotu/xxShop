<%@ Page Title="编辑微信指令操作" Language="C#" MasterPageFile="~/Admin/BasicNoFoot.Master"
    AutoEventWireup="true" CodeBehind="UpdateAction.aspx.cs" Inherits="YSWL.MALL.Web.Admin.WeChat.Action.UpdateAction" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal1" runat="server" Text="编辑微信指令操作" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal6" runat="server" Text="您可以进行编辑微信指令操作" />
                    </td>
                </tr>
            </table>
        </div>
