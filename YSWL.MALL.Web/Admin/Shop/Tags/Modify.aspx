<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="Modify.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.Tags.Modify" Title="编辑标签" %>
                ...
                <td class="tdbg">
                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td height="25">
                                <asp:TextBox ID="txtTagName" runat="server" Width="180px"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td height="25">
                                <asp:TextBox ID="txtCategoryText" runat="server" Width="180" ReadOnly="true" ></asp:TextBox>
