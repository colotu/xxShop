...
function switchSysBar() {
    ...
    if (obj.alt == "关闭左栏") {
        obj.alt = "打开左栏";
        obj.src = "/admin/images/butOpen.gif";
        document.getElementById("frmTitle").style.display = "none";
        var width, height;
        width = document.body.clientWidth - 12;
        height = document.body.clientHeight - 70;
        ...
        obj.alt = "关闭左栏";
        obj.src = "/admin/images/butClose.gif";
...
function ShowHideLayer(ID) {
    if (ID != tID) {
        ...
        if (tID != "") {
            document.getElementById("A" + tID).style.backgroundImage = "url(/admin/images/digital_left.gif)";
            if (document.getElementById("A" + tID).childNodes.length < 2) {
                document.getElementById("Span" + tID).style.backgroundImage = "url(/admin/images/digital_side.gif)";
            } else {
        ...
        document.getElementById("A" + ID).style.backgroundImage = "url(/admin/images/seg_left.gif)";
        if (document.getElementById("A" + ID).childNodes.length < 2) {
            document.getElementById("Span" + ID).style.backgroundImage = "url(/admin/images/seg_side.gif)";
            if (tID != "" && document.getElementById("A" + tID).childNodes.length >= 2) {
                if (triangle) { triangle.style.backgroundImage = "url(/admin/images/digital_side.gif)"; }
            }
        } else {
            document.getElementById("Span" + ID).style.backgroundImage = "none";
            if (triangle) { triangle.style.backgroundImage = "url(/admin/images/seg_side.gif)"; }
        }
