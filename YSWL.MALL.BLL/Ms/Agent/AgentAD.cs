...
namespace YSWL.MALL.BLL.Ms.Agent
{
	...
	public partial class AgentAD
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.Ms.Agent.AgentAD GetModelByCache(int AdvertisementId)
		{
			...
			return (YSWL.MALL.Model.Ms.Agent.AgentAD)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Ms.Agent.AgentAD> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Ms.Agent.AgentAD> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.Ms.Agent.AgentAD> modelList = new List<YSWL.MALL.Model.Ms.Agent.AgentAD>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.Ms.Agent.AgentAD model;
