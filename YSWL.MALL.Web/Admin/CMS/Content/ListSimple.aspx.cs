...
{
    public partial class ListSimple : PageBaseAdmin
    {
        ...
        private void BindTree()
        {
            ...
            DataSet ds = bllContentClass.GetTreeList(" ClassModel=3 ");//频道列表
