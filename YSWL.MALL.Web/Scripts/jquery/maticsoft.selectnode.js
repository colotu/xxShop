...
(function() {
    ...
    var currenScript = $('[src$="maticsoft.selectnode.js"]').last(); //锁定脚本引用
                    ...
                    for (var n = 0; n < resultData.DATA.length; n++) {
                        ...
                        for (var j = 0; j < resultData.DATA[n].length; j++) {
                            ...
                            for (var key in resultData.DATA[n][j]) {
                                ...
                                if (index == 2) {
                                    name = resultData.DATA[n][j][key].sub(30,true);
                                }
                                index++;
                            }
                            //是否选中
            ...
            success: function(resultData) {
                ...
                case "OK":
                    $(resultData.DATA).each(function() {
                        baseSelect.append("<option value='" + this.ClassID + "'>" + this.ClassName.sub(30,true) + "</option>");
                    });
                    break;
                default:
                    break;
