<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="AddNew.aspx.cs" Inherits="YSWL.MALL.Web.FriendlyLink.FLinks.AddNew" Title="<%$Resources:SiteSetting,ptFriendlyLink %>" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal1" runat="server" Text="<%$Resources:SiteSetting,ptFriendlyLink %>" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal2" runat="server" Text="<%$Resources:SiteSetting,lblFriendlyLink %>" />
                    </td>
                </tr>
            </table>
        </div>
            ...
            <tr>
                <td class="tdbg">
                    <table cellspacing="0" cellpadding="3" width="100%" border="0">
                         ...
                         <tr>
                            <td class="td_class">
                                <asp:Literal ID="Literal7" runat="server" Text="<%$Resources:SiteSetting,lblLinkType%>" />£º
                            </td>
                        ...
                        <tr id="ImgUrl">
                            <td class="td_class">
                                <asp:Literal ID="Literal4" runat="server" Text="<%$Resources:SiteSetting,lblImgUrl %>" />£º
                            </td>
                            <td>
                                <asp:TextBox ID="txtImgUrl" runat="server" Width="350px" ></asp:TextBox>
                        ...
                        <tr id="ImgWidth" style=" display:none">
                            ...
                            <td>
                                <asp:TextBox ID="txtImgWidth" runat="server" Width="350px"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr id="ImgHeight" style=" display:none">
                            ...
                            <td>
                                <asp:TextBox ID="txtImgHeight" runat="server" Width="350px"></asp:TextBox>
                            </td>
                        </tr>
                        <%--<input id="Button1" type="button" value="button" onclick="HideEle()" />--%>
                         <tr>
                            <td class="td_class">
                                <asp:Literal ID="Literal3" runat="server" Text="<%$Resources:SiteSetting,lblLinkName %>" />£º
                            </td>
                            <td>
                         ...
                         <tr>
                            <td class="td_class">
                                <asp:Literal ID="Literal13" runat="server" Text="<%$Resources:SiteSetting,lblIsDisplay %>" />£º
                            </td>
                            <td>
                            <asp:RadioButton runat="server" ID="radioBtnYes" Text="<%$Resources:SiteSetting,lblYes %>" Checked="true" GroupName="group1" />
                            <asp:RadioButton runat="server" Text="<%$Resources:SiteSetting,lblNo %>" GroupName="group1" />
                            </td>
                        </tr>

                        <tr>
                            <td class="td_class">
                                <asp:Literal ID="Literal5" runat="server" Text="<%$Resources:SiteSetting,lblLinkUrl%>" />£º
                            </td>
                            <td height="25">
                        ...
                        <tr>
                            <td class="td_class">
                                <asp:Literal ID="Literal6" runat="server" Text="<%$Resources:SiteSetting,lblLinkDescribe%>" />£º
                            </td>
                            <td>
                       ...
                       <%-- <tr>
                        ...
                        <tr>
                            ...
                            <td height="25">
                                <asp:TextBox ID="txtOrderID" runat="server" Width="350px" Text="1" ></asp:TextBox>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtOrderID"
                                    ErrorMessage="<%$Resources:SiteSetting,TooltipInputInt%>" ValidationExpression="^[+-]?\d+$"
                        ...
                        <tr>
                            ...
                            <td height="25">
                                <asp:TextBox ID="txtContactPerson" runat="server" Width="350px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="td_class">
                        ...
                        <tr>
                            ...
                            <td height="25">
                                <asp:TextBox ID="txtTelPhone" runat="server" Width="350px" onkeyup="value=value.replace(/[^\d]/g,'') "  onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))"  ></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="td_class">
