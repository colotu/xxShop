<%@ Page Language="C#" Title="新增佣金规则" MasterPageFile="~/Admin/BasicNoFoot.Master"
    AutoEventWireup="true"  CodeBehind="AddRule.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.Commission.AddRule" %>
                    ...
                    <td style="vertical-align: top;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                            ...
                            <tr  >
                                ...
                                <td height="25" class="td_content">
                                       <asp:CheckBox ID="chkStatus" runat="server"  Checked="True"/> 是
                                </td>
                            </tr>
