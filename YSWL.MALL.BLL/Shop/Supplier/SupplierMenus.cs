...
namespace YSWL.MALL.BLL.Shop.Supplier
{
	...
	public partial class SupplierMenus
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.Shop.Supplier.SupplierMenus GetModelByCache(int MenuId)
		{
			...
			return (YSWL.MALL.Model.Shop.Supplier.SupplierMenus)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Supplier.SupplierMenus> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Supplier.SupplierMenus> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.Shop.Supplier.SupplierMenus> modelList = new List<YSWL.MALL.Model.Shop.Supplier.SupplierMenus>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.Shop.Supplier.SupplierMenus model;
       ...
       /// <returns></returns>
        public List<YSWL.MALL.Model.Shop.Supplier.SupplierMenus> GetModelList(int top,int suppId)
        {
            DataSet ds = dal.GetList(top, string.Format(" SupplierId={0} and IsUsed=1 ", suppId), " Sequence ");
            return DataTableToList(ds.Tables[0]);
        }
        public List<YSWL.MALL.Model.Shop.Supplier.SupplierMenus> GetListByPageEx(string strWhere, string orderby, int startIndex, int endIndex)
        {
