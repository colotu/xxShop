...
{
    /// <summary>
    /// TOP API: alipay.micropay.order.direct.pay
    /// </summary>
    public class AlipayMicropayOrderDirectPayRequest : ITopRequest<AlipayMicropayOrderDirectPayResponse>
    {
        /// <summary>
        ...
        public void Validate()
        {
            ...
            RequestValidator.ValidateRequired("auth_token", this.AuthToken);
