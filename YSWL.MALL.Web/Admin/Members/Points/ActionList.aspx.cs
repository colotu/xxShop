...
namespace YSWL.MALL.Web.Admin.Members.Points
{
    ...
    {
        YSWL.MALL.BLL.Members.PointsAction actionBll = new YSWL.MALL.BLL.Members.PointsAction();
        ...
        {
            YSWL.MALL.Model.Members.PointsAction actionModel = new YSWL.MALL.Model.Members.PointsAction();
