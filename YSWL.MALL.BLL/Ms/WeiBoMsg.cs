...
namespace YSWL.MALL.BLL.Ms
{
	...
	public partial class WeiBoMsg
	{
        ...
        {
            return dal.DeleteList(Common.Globals.SafeLongFilter(WeiBoIdlist,0) );
        }
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSWL.MALL.Model.Ms.WeiBoMsg GetModelByCache(int WeiBoId)
        {
            ...
            return (YSWL.MALL.Model.Ms.WeiBoMsg)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.Ms.WeiBoMsg> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.Ms.WeiBoMsg> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.Ms.WeiBoMsg> modelList = new List<YSWL.MALL.Model.Ms.WeiBoMsg>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSWL.MALL.Model.Ms.WeiBoMsg model;
