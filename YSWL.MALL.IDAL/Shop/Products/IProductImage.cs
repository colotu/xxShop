...
namespace YSWL.MALL.IDAL.Shop.Products
{
	...
	public interface IProductImage
	{
		...
		/// 增加一条数据
		/// </summary>
		int Add(YSWL.MALL.Model.Shop.Products.ProductImage model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(YSWL.MALL.Model.Shop.Products.ProductImage model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		YSWL.MALL.Model.Shop.Products.ProductImage GetModel(int ProductImageId);
		/// <summary>
		/// 获得数据列表
		/// </summary>
	    ...
	    bool UpdateThumbnail(YSWL.MALL.Model.Shop.Products.ProductImage model);
