...
namespace YSWL.Json.RPC.Web
{
    ...
    public class JsonRpcHandler : JsonRpcService, IHttpHandler
    {
        ...
        {
            IDictionary config = (IDictionary) ConfigurationSettings.GetConfig("maticsoft/jsonrpc/features");
            ...
            if (config == null)
            {
                ...
                config = (IDictionary) ConfigurationSettings.GetConfig("maticsoft/json.rpc/features");
            }
