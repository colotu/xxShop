...
namespace YSWL.MALL.IDAL.Shop.Products
{
	...
	public interface IProductTypeBrand
	{
		...
		/// 增加一条数据
		/// </summary>
		bool Add(YSWL.MALL.Model.Shop.Products.ProductTypeBrand model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(YSWL.MALL.Model.Shop.Products.ProductTypeBrand model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		YSWL.MALL.Model.Shop.Products.ProductTypeBrand GetModel(int ProductTypeId,int BrandId);
		/// <summary>
		/// 获得数据列表
		/// </summary>
