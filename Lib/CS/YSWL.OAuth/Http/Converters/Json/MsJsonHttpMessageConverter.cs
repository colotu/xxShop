...
namespace YSWL.OAuth.Http.Converters.Json
{
    ...
    public class MsJsonHttpMessageConverter : AbstractHttpMessageConverter
    {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="MsJsonHttpMessageConverter"/> 
        /// with the media type 'application/json'.
        /// </summary>
        public MsJsonHttpMessageConverter() :
            this(new JsonMapper())
        {
        }
        ...
        public MsJsonHttpMessageConverter(JsonMapper mapper) :
            base(MediaType.APPLICATION_JSON, MediaType.ALL)
        {
            this.mapper = mapper;
        }
