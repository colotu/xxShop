<%@ Page Title="包装类型管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="PackageList.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.Package.PackageList" %>
            ...
            <div class="newsicon">
                <ul>
                    <li class="add-btn" runat="server"  ID="AddLi" >
                        <asp:HyperLink ID="hlkadd" runat="server" NavigateUrl="Packageadd.aspx" >新增</asp:HyperLink>
                    </li>
