...
<%@ Page Title="积分系统指令管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
   CodeBehind="ActionList.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Members.Points.ActionList" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal1" runat="server" Text="积分系统功能指令管理" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal2" runat="server" Text="积分系统指令是程序级功能行为，只有开发人员可以新增和维护该数据。" />
                    </td>
                </tr>
            </table>
        </div>
