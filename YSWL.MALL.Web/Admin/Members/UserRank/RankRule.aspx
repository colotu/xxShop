...
<%@ Page Title="成长值规则管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="RankRule.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Members.UserRank.RankRule" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal1" runat="server" Text="成长值规则管理" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal4" runat="server" Text="设置系统中需要进行成长值操作的规则，该规则只能由系统开发人员进行维护，请勿删除。" />
                    </td>
                </tr>
            </table>
        </div>
        ...
        <Grv:GridViewEx ID="gridView" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="条件限制" ItemStyle-HorizontalAlign="center">
                    <ItemTemplate>
                        <a href='RankLimit.aspx?LimitId=<%#Eval("LimitID") %>'>
