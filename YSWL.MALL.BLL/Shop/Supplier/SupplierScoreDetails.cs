...
namespace YSWL.MALL.BLL.Shop.Supplier
{
	...
	public partial class SupplierScoreDetails
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.Shop.Supplier.SupplierScoreDetails GetModelByCache(int ID)
		{
			...
			return (YSWL.MALL.Model.Shop.Supplier.SupplierScoreDetails)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Supplier.SupplierScoreDetails> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Supplier.SupplierScoreDetails> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.Shop.Supplier.SupplierScoreDetails> modelList = new List<YSWL.MALL.Model.Shop.Supplier.SupplierScoreDetails>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.Shop.Supplier.SupplierScoreDetails model;
