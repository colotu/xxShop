...
namespace YSWL.MALL.BLL.Shop.Sales
{
	...
	public partial class SalesUserRank
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.Shop.Sales.SalesUserRank GetModelByCache(int RuleId,int RankId)
		{
			...
			return (YSWL.MALL.Model.Shop.Sales.SalesUserRank)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Sales.SalesUserRank> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Sales.SalesUserRank> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.Shop.Sales.SalesUserRank> modelList = new List<YSWL.MALL.Model.Shop.Sales.SalesUserRank>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.Shop.Sales.SalesUserRank model;
        ...
        /// </summary>
        /// <returns></returns>
	    public List<YSWL.MALL.Model.Shop.Sales.SalesUserRank> GetAllSalesRank()
	    {

            string CacheKey = "GetAllSalesRank-SalesUserRank";
            object objModel = YSWL.Common.DataCache.GetCache(CacheKey);
            if (objModel == null)
            {
                try
            ...
            return (List<YSWL.MALL.Model.Shop.Sales.SalesUserRank>)objModel;
	    }
