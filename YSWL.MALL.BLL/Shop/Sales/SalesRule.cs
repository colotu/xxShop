...
namespace YSWL.MALL.BLL.Shop.Sales
{
	...
	public partial class SalesRule
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.Shop.Sales.SalesRule GetModelByCache(int RuleId)
		{
			...
			return (YSWL.MALL.Model.Shop.Sales.SalesRule)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Sales.SalesRule> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Sales.SalesRule> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.Shop.Sales.SalesRule> modelList = new List<YSWL.MALL.Model.Shop.Sales.SalesRule>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.Shop.Sales.SalesRule model;
        ...
        /// 获得数据列表
        /// </summary>
        public DataSet GetAllList(int type)
        {
            return GetList(" Type="+type);
        }
        #endregion  ExtensionMethod

        #region saas app

        public List<YSWL.MALL.Model.Shop.Sales.SalesRule> GetListByPageApp(string ruleName, int type = 0, int? page = 1,
          int pageNum = 30)
        {
            ...
            {
                strWhere.AppendFormat(" and  RuleName like '%{0}%'", Common.InjectionFilter.SqlFilter(ruleName));
            }
