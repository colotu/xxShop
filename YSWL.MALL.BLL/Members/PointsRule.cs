...
namespace YSWL.MALL.BLL.Members
{
	...
	public partial class PointsRule
	{
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSWL.MALL.Model.Members.PointsRule GetModelByCache(int RuleId)
        {
            ...
            return (YSWL.MALL.Model.Members.PointsRule)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.Members.PointsRule> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.Members.PointsRule> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.Members.PointsRule> modelList = new List<YSWL.MALL.Model.Members.PointsRule>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSWL.MALL.Model.Members.PointsRule model;
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSWL.MALL.Model.Members.PointsRule GetModel(int actionId,int userId)
        {
        ...
        public List<YSWL.MALL.Model.Members.PointsRule> GetListByPageExt(string strWhere, string orderby, int startIndex, int endIndex)
        {
