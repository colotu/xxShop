<%@ Page Title="发送客服消息" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="SendMsg.aspx.cs" Inherits="YSWL.MALL.Web.Admin.WeChat.User.SendMsg" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".delMsg").die("click").live("click", function () {
                ...
                var self = $(this);
                $.ajax({
                    url: ("SendMsg.aspx?timestamp={0}").format(new Date().getTime()),
            ...
            $("#btnSave").die("click").live("click", function () {
                ...
                $.ajax({
                    url: ("SendMsg.aspx?timestamp={0}").format(new Date().getTime()),
                    type: 'POST', dataType: 'json', timeout: 10000,
                    data: { Action: "AddMsg", Callback: "true", Title: title, ImageUrl: path, Desc: desc, UrlType: urltype, Url: txturl, Category: category },
                    success: function (resultData) {
                        if (resultData.STATUS == "Success") {
            ...
            $("#btnPublish").click(function () {
                ...
                $.ajax({
                    url: ("SendMsg.aspx?timestamp={0}").format(new Date().getTime()),
                    type: 'POST', dataType: 'json', timeout: 10000,
                    data: { Action: "Publish", Callback: "true", ItemIds: itemIds, UserName: username, GroupId: group, MsgId: msgId },
                    success: function (resultData) {
                        if (resultData.STATUS == "Success") {
                        ...
                        if (resultData.STATUS == "NoUser") {
                            ShowFailTip("没有48小时用户接收消息");
                        }
                        if (resultData.STATUS == "FAILED") {
                            ShowFailTip("服务器没有返回数据，可能服务器忙，请稍候再试");
                        }
            ...
            $("#btnPublishVoice").click(function () {
                ...
                $.ajax({
                    url: ("SendMsg.aspx?timestamp={0}").format(new Date().getTime()),
                    type: 'POST', dataType: 'json', timeout: 10000,
                    data: { Action: "PublishVoice", Callback: "true", Path: voicePath, UserName: username, GroupId: group, MsgId: msgId },
                    success: function (resultData) {
                        if (resultData.STATUS == "Success") {
                            $("#txtFileName").text("")
                            $("#txtVoicePath").val("");
                        ...
                        <td class="tdbg">
                            <table cellspacing="0" cellpadding="3" width="100%" border="0">
                                ...
                                <tr class="txt_s">
                                    ...
                                    <td height="25">
                                        <asp:Button ID="btnSaveText" runat="server" Text="发送" class="add-btn" OnClick="btnSaveText_Click">
                                        </asp:Button>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table cellspacing="0" cellpadding="3" width="100%" border="0">
                                ...
                                <tr class="news_r">
                                    ...
                                    <td height="25">
                                        ...
                                        <input id="txtUrl" type="text"  class="mar-t10" />
                                ...
                                <tr class="news_r">
                                    ...
                                    <td height="25" colspan="3">
                                        <input id="btnSave" type="button" value="新增" class="adminsubmit-short add-btn" />
                                    </td>
                                </tr>
<%--                                <tr class="news_r">
                                    <td class="td_class">
                                ...
                                <tr class="txt_r">
                                    ...
                                    <td height="25">
                                        <input id="btnPublish" type="button" value="全部发送" class="adminsubmit add-btn" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td class="tdbg">
                            <table cellspacing="0" cellpadding="3" width="100%" border="0">
                                ...
                                <tr class="txt_s">
                                    ...
                                    <td height="25">
                                        <input id="btnPublishVoice" type="button" value="全部发送" class="add-btn" />
                                    </td>
                                </tr>
                            </table>
                        </td>
