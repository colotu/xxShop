...
<%@ Page Title="成长值规则管理" Language="C#" MasterPageFile="~/Admin/Basic.Master"
    AutoEventWireup="true"  CodeBehind="UpdateRule.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Members.UserRank.UpdateRule" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                         <asp:Literal ID="Literal1" runat="server" Text="修改成长值规则" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                         <asp:Literal ID="Literal6" runat="server" Text="您可以进行修改成长值规则操作" />
                    </td>
                </tr>
            </table>
        </div>
            ...
            <tr>
                <td class="tdbg">
                    <table cellspacing="0" cellpadding="3" width="100%" border="0">
                        ...
                        <tr>
                            <td class="td_class">
                                <asp:Literal ID="Literal4" runat="server" Text="影响成长值数" />：
                            </td>
                            <td height="25">
                               
                                <asp:TextBox ID="tScore" TabIndex="3" runat="server" Width="250px" MaxLength="20" Text="0"></asp:TextBox>
                                <asp:RangeValidator ID="RangeValidator1" Type="Integer" Display="Dynamic" ControlToValidate="tScore" MinimumValue="0" MaximumValue="1000" runat="server" ErrorMessage="数字在0-1000之间"></asp:RangeValidator>
                            </td>
                        </tr>
                        <tr>
