<%@ Page Title="图片重新生成" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="PhotoReGen.aspx.cs" Inherits="YSWL.MALL.Web.Admin.CMS.Photo.PhotoReGen" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="/admin/js/jquery/PhotoReGen.js" type="text/javascript"></script>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                ...
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal4" runat="server" Text="您可以根据条件选择产品进行缩略图生成操作" />
                    </td>
                </tr>
            </table>
        </div>
