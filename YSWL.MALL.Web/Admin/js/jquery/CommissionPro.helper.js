...
function AddRuleProduct(productId, ruleId, name) {
    $.ajax({
        ...
        data: { Action: "AddCommissionPro", Callback: "true", ProductId: productId, RuleId: ruleId, ProductName: name },
        async: false,
...
function DeleteRuleProduct(productId, ruleId) {
    $.ajax({
        url: "/ShopManage.aspx",
        type: 'POST', dataType: 'json', timeout: 10000,
        data: { Action: "DeleteCommissionPro", Callback: "true", ProductId: productId, RuleId: ruleId },
        async: false,
        success: function (resultData) {
