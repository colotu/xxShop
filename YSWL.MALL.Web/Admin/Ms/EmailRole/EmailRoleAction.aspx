<%@ Page Title="<%$ Resources:Site, ptEditRole %>" Language="C#" MasterPageFile="~/Admin/BasicAddSearch.Master"
    AutoEventWireup="true" CodeBehind="EmailRoleAction.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Ms.EmailRole.EmailRoleAction" %>

<%@ Register Assembly="YSWL.MALL.Web" Namespace="YSWL.MALL.Web.Controls" TagPrefix="cc1" %>
<%--<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>--%>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_Title" runat="server">
    <asp:Literal ID="Literal2" runat="server" Text="邮件配置" />
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_TitleButton"
    runat="server">
    <asp:Literal ID="Literal6" runat="server" Text="您可以为不同的角色分发邮件" />
</asp:Content>
                ...
                <table cellpadding="5" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td align="center" height="25" colspan="2">
                            <b>
                                <asp:Literal ID="Literal1" runat="server" Text="选择邮件类型" />:
                    ...
                    <tr>
                        <td valign="Top" width="250px">
                            <b>
                                <asp:Literal ID="Literal3" runat="server" Text="角色类别" />
                            </b>:
