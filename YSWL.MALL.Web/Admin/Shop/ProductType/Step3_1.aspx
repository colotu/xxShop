<%@ Page Language="C#" MasterPageFile="~/Admin/BasicNoFoot.Master" AutoEventWireup="true"
    CodeBehind="Step3_1.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.ProductType.Step3_1"
    Title="商品类型管理" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("[id$='rbPic']").click(function () {
                $(".claPic").show();
            });
            $("[id$='rbText']").click(function () {
                $(".claPic").hide();
            });
        });
    </script>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal2" runat="server" Text="新增新的规格" />
                    </td>
                </tr>
                <tr>
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td height="25">
                                ...
                                <YSWL:ValidateTarget ID="ValidateTargetName" runat="server"  OkMessage="输入正确！"  Description="规格名称不能为空，长度限制在1-15个字符之间！"
                                    ControlToValidate="txtAttributeName" ContainerId="ValidatorContainer">
                                    <Validators>
                                        <YSWL:InputStringClientValidator ErrorMessage="规格名称不能为空，长度限制在1-15个字符之间！" LowerBound="1"
                                            UpperBound="15" />
                                    </Validators>
                                </YSWL:ValidateTarget>
                            </td>
                        ...
                        <tr class="claPic" style="display: none">
                            <td class="td_class">
                            </td>
                            <td height="25">
