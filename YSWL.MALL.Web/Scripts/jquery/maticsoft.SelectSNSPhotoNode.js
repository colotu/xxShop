...
;
(function () {
    var currenScript = $('[src$="maticsoft.SelectSNSPhotoNode.js"]').last(); //锁定脚本引用
    ...
    function InitLastSelect() {
        ...
        $.ajax({
            ...
            timeout: 10000,
            async: false,
            data: { Action: "GetPhotoParentNode", NodeId: $('[HFID=' + currentBaseSelectGuid + ']').val() },
    ...
    function LoadChildNodeData(send) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            timeout: 10000,
            data: { Action: "GetPhotoChildNode", ParentId: $(send).val() },
            async: false,
            success: function (resultData) {
                switch (resultData.STATUS) {
                    case "OK":
