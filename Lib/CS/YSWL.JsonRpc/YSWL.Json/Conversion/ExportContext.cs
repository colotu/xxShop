...
namespace YSWL.Json.Conversion
{
    ...
    using YSWL.Json.Conversion.Converters;
    using YSWL.Json.Reflection;
        ...
        private static ExporterCollection StockExporters
        {
            get
            {
                if (_stockExporters == null)
                {
                    ...
                    IList typeList = (IList)ConfigurationSettings.GetConfig("maticsoft/json.conversion.exporters");
