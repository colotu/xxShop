...
namespace YSWL.MALL.SQLServerDAL.Shop.Shipping
{
	...
	public partial class ShippingPayment:IShippingPayment
	{
		...
		public int GetMaxId()
		{
		return DBHelper.DefaultDBHelper.GetMaxID("ShippingModeId", "Shop_ShippingPayment"); 
		}
		...
		public YSWL.MALL.Model.Shop.Shipping.ShippingPayment GetModel(int ShippingModeId,int PaymentModeId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ShippingModeId,PaymentModeId from Shop_ShippingPayment ");
			strSql.Append(" where ShippingModeId=@ShippingModeId and PaymentModeId=@PaymentModeId ");
			SqlParameter[] parameters = {
					new SqlParameter("@ShippingModeId", SqlDbType.Int,4),
					new SqlParameter("@PaymentModeId", SqlDbType.Int,4)			};
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Shop_ShippingPayment T ");
