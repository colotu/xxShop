<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="AddCommand.aspx.cs" Inherits="YSWL.MALL.Web.Admin.WeChat.Command.AddCommand" %>
                ...
                <td class="tdbg">
                    <table cellspacing="0" cellpadding="3" width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td height="25">
                                <asp:DropDownList ID="dropAction" runat="server" Width="320px" OnSelectedIndexChanged="dropAction_IndexChange" AutoPostBack="true" >
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td height="25">
                                <asp:TextBox ID="txtSequence"  runat="server" Width="318px" MaxLength="30"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td height="25">
                                <asp:DropDownList ID="ddParseType" runat="server" Width="155px"  >
