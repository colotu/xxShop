...
namespace YSWL.OAuth.v2
{
    ...
    public class AccessGrant
    {
        ...
        public AccessGrant(string accessToken, string[] extraData)
            : this(accessToken, null, null, null, extraData)
        {
        }
        ...
        /// <param name="extraData">The extra data of the extra</param>
        public AccessGrant(AccessGrant accessGrant, string[] extraData)
            : this(accessGrant.AccessToken, accessGrant.Scope,
            accessGrant.RefreshToken, extraData, accessGrant.ExpireTime) { }
