...
<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
   CodeBehind="AddCountDown.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.PromoteSales.AddCountDown" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                ...
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal6" runat="server" Text="您可以进行新增限时抢购商品操作" />
                    </td>
                </tr>
            </table>
        </div>
                ...
                <td class="tdbg">
                    <table cellspacing="0" cellpadding="3" width="100%" border="0">
                        ...
                        <tr >
                            ...
                            <td class="td_class">
                                <asp:Literal ID="Literal7" runat="server" Text="单次购买限购数量" />：
                            </td>
                            <td height="25">
                                <asp:TextBox ID="txtLimitCount" runat="server" Width="80px" MaxLength="30" Text="1"></asp:TextBox>
                            </td>
                        </tr>
