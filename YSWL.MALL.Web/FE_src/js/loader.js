...
$(document).ready(function () {
    // loading
    var domain = 'http://static.yuns56.cn'; //window.location.host;  未使用
    var yswl_jquery = domain + '/dist/lib/yswl.jquery.min.js',
    msgbox = domain + '/dist/lib/msgbox-2.0/js/msgbox.min.js';
    // Loader.load(jquery, your).load(my);    //可以并行加载的js脚本尽可能地并行加载。
    Loader.load(yswl_jquery, msgbox).wait(function () {
        // console.log("yeah, yswl.jquery.js and msgbox.js was loaded") 
    });
});