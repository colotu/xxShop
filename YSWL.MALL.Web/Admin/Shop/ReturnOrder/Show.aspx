<%@ Page Language="C#"  Title="详情" AutoEventWireup="true" MasterPageFile="~/Admin/BasicNoFoot.Master" CodeBehind="Show.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.ReturnOrder.Show" %>
                        ...
                        <td style="vertical-align: top;">
                           ...
                           <tr>
                               ...
                               <tr>
                                  ...
                                  <div style="margin-left: 50px;margin-top: -19px;color:#E29E25;"> 提示：1.如果退货类型为【整单退】,应退金额等于原订单的实际支付金额</br>
                        ...
                        <td class="tdbg">
                            <cc1:GridViewEx ID="gridView" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ControlStyle-Width="80" HeaderText="出售单价" ItemStyle-HorizontalAlign="Center"
                                        ItemStyle-Width="80">
                                        <ItemTemplate>
                                            <span class="txtprice">
