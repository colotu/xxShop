...
{
    public partial class CMSList : PageBaseAdmin
    {
        ...
        {
            //获取该主区域 下的所有模板
            List<YSWL.MALL.Model.Ms.Theme> themeList = YSWL.MALL.Web.Components.FileHelper.GetThemes("CMS");
            //获取当前主模板
            string name = YSWL.MALL.BLL.SysManage.ConfigSystem.GetValueByCache("CMS_Theme");
        ...
        protected void DataListPhoto_ItemCommand(object source, DataListCommandEventArgs e)
        {
            if (e.CommandName == "start")
            {
                if (e.CommandArgument != null)
                {
                    ...
                    //写
                    YSWL.MALL.BLL.SysManage.ConfigSystem.Modify("CMS_Theme", name, "CMS模板的名称");
                    Cache.Remove("ConfigSystemHashList");    //清除网站设置的缓存文件
                    MessageBox.ShowSuccessTip(this, "启用成功", "CMSList.aspx");
                }
            }
        }
