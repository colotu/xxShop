...
;
(function () {
    var currenScript = $('[src$="maticsoft.SelectSNSnode.js"]').last(); //锁定脚本引用
    ...
    function InitLastSelect() {
        ...
        $.ajax({
            ...
            timeout: 10000,
            async: false,
            data: { Action: "GetSNSParentNode", NodeId: $('[HFID=' + currentBaseSelectGuid + ']').val() },
    ...
    function LoadChildNodeData(send) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            timeout: 10000,
            data: { Action: "GetSNSChildNode", ParentId: $(send).val() },
            async: false,
            success: function (resultData) {
                switch (resultData.STATUS) {
                    case "OK":
