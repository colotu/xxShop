...
using YSWL.OAuth.Http.Client.Interceptor;
using YSWL.OAuth.Http.Converters;
using YSWL.OAuth.Http.Converters.Xml;
#if NET_3_5 || SILVERLIGHT
using YSWL.OAuth.Http.Converters.Json;
#endif
#if NET_3_5 && !SILVERLIGHT
using YSWL.OAuth.Http.Converters.Feed;
#endif
using YSWL.OAuth.Rest.Client.Support;
using UriTemplate = YSWL.OAuth.Util.UriTemplate; // UriTemplate exists in .NET Framework since 3.5
using ArgumentUtils = YSWL.OAuth.Util.ArgumentUtils;

namespace YSWL.OAuth.Rest.Client
{
    /// <summary>
