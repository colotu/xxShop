...
namespace YSWL.MALL.IDAL.Shop.Sales
{
	...
	public interface ISalesRule
	{
		...
		/// 增加一条数据
		/// </summary>
		int Add(YSWL.MALL.Model.Shop.Sales.SalesRule model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(YSWL.MALL.Model.Shop.Sales.SalesRule model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		YSWL.MALL.Model.Shop.Sales.SalesRule GetModel(int RuleId);
		YSWL.MALL.Model.Shop.Sales.SalesRule DataRowToModel(DataRow row);
		/// <summary>
		/// 获得数据列表
		/// </summary>
