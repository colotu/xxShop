...
namespace YSWL.MALL.BLL.Shop.Order
{
	...
	public partial class OrdersHistory
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.Shop.Order.OrdersHistory GetModelByCache(long OrderId)
		{
			...
			return (YSWL.MALL.Model.Shop.Order.OrdersHistory)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Order.OrdersHistory> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Order.OrdersHistory> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.Shop.Order.OrdersHistory> modelList = new List<YSWL.MALL.Model.Shop.Order.OrdersHistory>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.Shop.Order.OrdersHistory model;
