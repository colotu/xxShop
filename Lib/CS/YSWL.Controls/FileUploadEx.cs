...
namespace YSWL.Controls
{
    ...
    public class FileUploadEx : YSWL.Controls.WebControl
    {
        /// <summary>
        /// TextBox 控件变量
        /// </summary>
        protected System.Web.UI.WebControls.TextBox txt = new System.Web.UI.WebControls.TextBox();

        /// <summary>
        /// Label 控件变量
        /// </summary>
        protected System.Web.UI.WebControls.Label lblMsg = new Label();

        /// <summary>
        /// Button 控件变量
        /// </summary>
        protected System.Web.UI.WebControls.Button btnUpload = new System.Web.UI.WebControls.Button();
        ...
        public FileUploadEx()
        {
            ...
            txt.Attributes.Add("rows", "2");
            txt.Attributes.Add("cols", "53");
            txt.CssClass = "colorblur";
            ...
            btnUpload.Click += new EventHandler(UpFile_Click);
        ...
        /// <summary>
        /// 要上传的文件的类型，如：.gif , .jpg , .png
        /// </summary>
        [Bindable(true), Category("Appearance"), DefaultValue("jpg,gif,png")]
        ...
        public bool IsThumbnailImage
        {
            get
            {
                object o = ViewState["IsThumbnailImage"];
                bool result;
                if (o == null)
                {
                    result = true;
            ...
            set
            {
                ViewState["IsThumbnailImage"] = value;
            }
        }
        ...
        {
            string sSavePath = HttpContext.Current.Server.MapPath("/" + UpFilePath + "/");
            ...
            if (fileUpload.PostedFile != null)
            {
                ...
                if (nFileLen == 0)
                {
                    lblMsg.Text = "<br /><font color=red>没有选定被上传的文件！</font></b>";
                    return "";
                }

                if (FileType.IndexOf(System.IO.Path.GetExtension(myFile.FileName).ToLower()) < 0)
                {
                    lblMsg.Text = "<br /><font color=red>文件必须是以" + FileType.Replace("|", " , ") + "为扩展名的文件！</font></b>";
                    return "";
                }
                ...
                string sFilename = strGuid + System.IO.Path.GetExtension(myFile.FileName).ToLower();
                ...
                if ((System.IO.Path.GetExtension(myFile.FileName).ToLower() == ".jpg") || (System.IO.Path.GetExtension(myFile.FileName).ToLower() == ".gif") || (System.IO.Path.GetExtension(myFile.FileName).ToLower() == ".png"))
                {
                    ...
                    try
                    {
                        ...
                        if (IsThumbnailImage)
                        {
                            ...
                            string sFileThumname = "S_" + strGuid + System.IO.Path.GetExtension(myFile.FileName).ToLower();
                    ...
                    catch (ArgumentException errArgument)
                    {
                        ...
                        lblMsg.Text = errArgument.ToString();
        ...
        public void GetThumbnailImage(int width, int height, int left, int right, string picpath, string picthumpath)
        {
            ...
            if ((WaterMarkText == null) || (WaterMarkText == ""))
                ...
                g.DrawString(WaterMarkText, new Font("Courier New", 14), new SolidBrush(Color.Black), left, right);//写入文字到图片中
    ...
    public class ThumbnailImageConverter : StringConverter
    {
        ...
        public override System.ComponentModel.TypeConverter.StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            ...
            controlsArray.Add(true);
            controlsArray.Add(false);
