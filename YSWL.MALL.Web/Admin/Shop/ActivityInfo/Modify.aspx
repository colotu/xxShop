<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.ActivityInfo.Modify" Title="修改页" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                ...
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal6" runat="server" Text="您可以进行编辑促销活动操作" />
                    </td>
                </tr>
            </table>
        </div>
	...
	：</td>
	<td height="25">
         <asp:DropDownList ID="ddlRule" runat="server" Enabled="false">      
                    </asp:DropDownList>
	</td></tr>
  <tr class="txtCategory"  >
	...
	：</td>
	<td height="25">
    <label runat="server" id="lblBuySKU"></label>
	</td></tr>
	<tr  >
	<td class="td_class">
		指定数量
	：</td>
	<td height="25">
		<asp:TextBox id="txtBuyCount" runat="server" Width="50px"></asp:TextBox>
	</td></tr>
	...
	：</td>
	<td height="25">
    <label runat="server"  id="lblSKU"></label>
	</td></tr>
	...
	<td height="25">
		<asp:TextBox id="txtCount" runat="server" Width="50px"></asp:TextBox>
	        ...
	        <tr>
                            ...
                            <td height="25">
                                <asp:TextBox ID="txtLimitPrice" runat="server" Width="100px"></asp:TextBox> -- <asp:TextBox ID="txtLimitMaxPrice" runat="server" Width="100px"></asp:TextBox>
                            </td>
                        </tr>
	...
	：</td>
	<td height="25">
	<label runat=server  id="lblCreatedUserId"></label>
	</td></tr>
     	<tr>
	<td class="td_class">
		创建时间
	：</td>
	<td height="25">
	<label runat=server  id="lblCreatedDate"></label>
	</td></tr>
       <tr>
                            <td class="td_class">
                            </td>
