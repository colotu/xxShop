...
skusTableTdBase += ' <td ><input value="{3}" id="Stock" class="OnlyNum" style="width:90px;" maxlength="5" type="text"/></td>';
skusTableTdBase += '<td ><input value="{4}" id="AlertStock" class="OnlyNum" style="width:90px;" maxlength="5" type="text"/></td>';
skusTableTdBase += '<td ><input value="{5}" id="Weight" class="OnlyNum" style="width:90px;" maxlength="10" type="text"/></td>';
...
//            timeout: 10000,
//            async: true,
//            data: { Action: "ProductAccessoriesManage", pid: currentPid,actype:1 },
//            success: function (resultData) {
//                switch (resultData.STATUS) {
//                    case "SUCCESS":
//                       // $('#AddProductAccessoriesTR').hide();
