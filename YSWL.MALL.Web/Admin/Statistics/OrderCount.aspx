<%@ Page Title="每日订单统计" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="OrderCount.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Statistics.OrderCount" %>
                    ...
                    <cc1:GridViewEx ID="gridView" runat="server" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="销售额 " ItemStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                    <div class="tx-r"><%#Eval("ToalAmount") == null ? "0.00" : Convert.ToDecimal(Eval("ToalAmount").ToString()).ToString("F")%></div>    
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
