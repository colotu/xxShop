...
<%@ Page Title="用户等级系统指令管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
  CodeBehind="ActionList.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Members.UserRank.ActionList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $(".iframe").colorbox({ iframe: true, width: "480", height: "320", overlayClose: false });
        });
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="newslistabout">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal1" runat="server" Text="用户等级系统功能指令管理" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal2" runat="server" Text="用户等级系统指令是程序级功能行为，只有开发人员可以新增和维护该数据。" />
                    </td>
                </tr>
            </table>
        </div>
        ...
        <cc1:GridViewEx ID="gridView" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            BorderWidth="1px" ShowCheckAll="false" DataKeyNames="ActionId">
            <Columns>
                <asp:TemplateField HeaderText="系统指令ID" ItemStyle-HorizontalAlign="center">
                    <ItemTemplate>
                        <%# Eval("ActionId")%>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="系统指令名称" ItemStyle-HorizontalAlign="center">
                    <ItemTemplate>
                        <%# Eval("Name")%>
                    </ItemTemplate>
                </asp:TemplateField>
