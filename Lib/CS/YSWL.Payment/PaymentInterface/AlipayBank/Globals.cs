...
namespace YSWL.Payment.PaymentInterface.AlipayBank
{
    internal sealed class Globals
    {
        ...
        internal static string CreatDirectUrl(string gateway, string service, string partner, string sign_type, string out_trade_no, string subject, string body, string payment_type, string total_fee, string show_url, string seller_email, string key, string return_url, string _input_charset, string notify_url, string extend_param, string token, string paymethod, string defaultbank)
        {
            int num;
            string[] strArray;
            if (string.IsNullOrEmpty(token))
            {
                strArray = new string[] { "service=" + service, "partner=" + partner, "subject=" + subject, "body=" + body, "out_trade_no=" + out_trade_no, "total_fee=" + total_fee, "show_url=" + show_url, "payment_type=" + payment_type, "seller_email=" + seller_email, "notify_url=" + notify_url, "_input_charset=" + _input_charset, "return_url=" + return_url, "extend_param=" + extend_param, "paymethod=" + paymethod, "defaultbank=" + defaultbank };
            }
            else
            {
                strArray = new string[] { "service=" + service, "partner=" + partner, "subject=" + subject, "body=" + body, "out_trade_no=" + out_trade_no, "total_fee=" + total_fee, "show_url=" + show_url, "payment_type=" + payment_type, "seller_email=" + seller_email, "notify_url=" + notify_url, "_input_charset=" + _input_charset, "return_url=" + return_url, "extend_param=" + extend_param, "paymethod=" + paymethod, "defaultbank=" + defaultbank, "token=" + token };
            }
