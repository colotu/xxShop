...
(function ($) {
    ...
    $.jBox.stateDefaults = { content: '', buttons: { '确定': 'ok' }, buttonsFocus: 0, loaded: function (h) { }, submit: function (v, h, f) { return true; } };
        ...
        if (box != undefined && box != null) {
            ...
            $next.slideDown(350, function () {
                window.setTimeout(function () {
                    ...
                    if (typeof $.jBox.defaults.loaded == 'function') {
                        $.jBox.defaults.loaded(box.find('.jbox-state:visible').find('.jbox-content'));
                    }
                }, 20);
            });
        }
