...
namespace YSWL.Web.Admin.CMS.Content
{
    public partial class UpdateSimpleSingleArticle : PageBaseAdmin
    {
        private YSWL.BLL.CMS.Content bll = new YSWL.BLL.CMS.Content();
        private YSWL.BLL.CMS.ContentClass bllContentClass = new YSWL.BLL.CMS.ContentClass();
        ...
        {
            YSWL.Model.CMS.Content model = bll.GetModel(ContentID);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            YSWL.Model.CMS.ContentClass modelContentClass = bllContentClass.GetModelByCache(ClassID);
