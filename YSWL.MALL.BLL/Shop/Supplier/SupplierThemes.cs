...
namespace YSWL.MALL.BLL.Shop.Supplier
{
	...
	public partial class SupplierThemes
	{
		...
		{
			return dal.DeleteList(Common.Globals.SafeLongFilter(ThemeIdlist ,0) );
		}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.Shop.Supplier.SupplierThemes GetModelByCache(int ThemeId)
		{
			...
			return (YSWL.MALL.Model.Shop.Supplier.SupplierThemes)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Supplier.SupplierThemes> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Supplier.SupplierThemes> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.Shop.Supplier.SupplierThemes> modelList = new List<YSWL.MALL.Model.Shop.Supplier.SupplierThemes>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.Shop.Supplier.SupplierThemes model;
