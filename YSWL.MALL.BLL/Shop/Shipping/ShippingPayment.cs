...
namespace YSWL.MALL.BLL.Shop.Shipping
{
	...
	public partial class ShippingPayment
	{
		...
		{
			return dal.Exists(ShippingModeId,PaymentModeId);
		}
		...
		public bool Delete(int ShippingModeId,int PaymentModeId)
		{
			...
			return dal.Delete(ShippingModeId,PaymentModeId);
		}
		...
		public YSWL.MALL.Model.Shop.Shipping.ShippingPayment GetModel(int ShippingModeId,int PaymentModeId)
		{
			...
			return dal.GetModel(ShippingModeId,PaymentModeId);
		}

		/// <summary>
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.Shop.Shipping.ShippingPayment GetModelByCache(int ShippingModeId,int PaymentModeId)
		{
			...
			if (objModel == null)
			{
				try
				{
					objModel = dal.GetModel(ShippingModeId,PaymentModeId);
					if (objModel != null)
					{
			...
			return (YSWL.MALL.Model.Shop.Shipping.ShippingPayment)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Shipping.ShippingPayment> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Shipping.ShippingPayment> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.Shop.Shipping.ShippingPayment> modelList = new List<YSWL.MALL.Model.Shop.Shipping.ShippingPayment>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.Shop.Shipping.ShippingPayment model;
