...
namespace YSWL.MALL.IDAL.Shop.Products
{
	...
	public interface IRelatedProduct
	{
		...
		/// 增加一条数据
		/// </summary>
		bool Add(YSWL.MALL.Model.Shop.Products.RelatedProduct model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(YSWL.MALL.Model.Shop.Products.RelatedProduct model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		YSWL.MALL.Model.Shop.Products.RelatedProduct GetModel(int RelatedId,long ProductId);
		/// <summary>
		/// 获得数据列表
		/// </summary>
