...
namespace YSWL.Json.Dynamic
{
    ...
    {
        // warning CS0649: Field 'YSWL.Dynamic.Option<T>.None' is never assigned to, and will always have its default value 
...
namespace YSWL.Json.Dynamic
{
    ...
    internal sealed class DynamicMetaObject<T> : DynamicMetaObject
    {
        ...
        public override DynamicMetaObject BindInvokeMember(InvokeMemberBinder binder, DynamicMetaObject[] args)
        {
            ...
            // >>> require 'YSWL.Json'
            // => true
            // >>> o = YSWL::Json::JsonObject.new
            // => {}
            // >>> o.foo = 123
            // => 123
            // >>> o.foo
            // (ir):1: undefined method `foo' for {"foo":123}:YSWL::Json::JsonObject (NoMethodError)
        }
