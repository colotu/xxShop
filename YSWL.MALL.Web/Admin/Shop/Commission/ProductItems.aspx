<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/BasicNoFoot.Master" AutoEventWireup="true"
   CodeBehind="ProductItems.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.Commission.ProductItems" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="/admin/js/jquery/CommissionPro.helper.js" type="text/javascript"></script>
                ...
                <asp:Panel ID="Panel1" runat="server" DefaultButton="btnSearch">
                    ...
                    <ul>
                        <li>
                            ...
                            <asp:Button ID="btnAddAll" OnClick="btnAddAll_Click" runat="server" Text="一键加入" CssClass="adminsubmit" />
                        </li>
                    </ul>
                </asp:Panel>
                <div class="content">
