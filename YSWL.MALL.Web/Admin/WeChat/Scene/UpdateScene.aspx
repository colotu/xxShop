...
<%@ Page Title="编辑渠道推广操作" Language="C#" MasterPageFile="~/Admin/BasicNoFoot.Master" AutoEventWireup="true"
CodeBehind="UpdateScene.aspx.cs" Inherits="YSWL.MALL.Web.Admin.WeChat.Scene.UpdateScene" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal1" runat="server" Text="编辑渠道推广操作" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal6" runat="server" Text="您可以进行编辑渠道推广操作" />
                    </td>
                </tr>
            </table>
        </div>
