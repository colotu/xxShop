...
namespace YSWL.OAuth.IO
{
	...
	/// <remarks>
	/// <para>
	/// In contrast to other <see cref="YSWL.OAuth.IO.IResource"/> implementations, 
    /// this is an adapter for an already opened resource - the <see cref="YSWL.OAuth.IO.IResource.IsOpen"/> 
	...
	public class StreamResource : IResource
	{
		...
		/// <summary>
		/// Creates a new instance of the <see cref="YSWL.OAuth.IO.StreamResource"/> class.
		/// </summary>
