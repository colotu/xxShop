(function () {
        ...
        $('.results_pos').queue(function () {
            $(this).hide().show(function () {
                ...
                nextButton.bind("click", function () {
                    ...
                    $("[id$='txtCategoryText']").val($("#fullName").text());
                    $.fn.colorbox.close();
                });
    ...
    function GetCategories(parentCategoryId) {
        ...
        $.ajax({
            url: ("SelectTagsCategory.aspx?timestamp={0}").format(new Date().getTime()),
            type: 'POST',
            dataType: 'json',
            timeout: 10000,
    ...
    function LoadState(categoryId) {
        $.ajax({
            url: ("~/Admin/Shop/TagsType/SelectCategory.aspx?timestamp={0}").format(new Date().getTime()),
            type: 'POST',
            dataType: 'json',
            timeout: 10000,
