...
<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
  CodeBehind="UpdateInfo.aspx.cs" Inherits="YSWL.MALL.Web.Admin.WeChat.Activity.UpdateInfo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var img = $('[id$=hfPath]').val().format('T_');
            $('.file_uploadUploader').css("background", backgtoundImgBase.format(img));
            //初始化 控件
            var limitType = $("[name$='rblLimitType'][checked]").val();
            if (limitType == 1) {
                $(".claDay").show();
                $(".claAll").hide();
            }
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                ...
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal6" runat="server" Text="您可以进行编辑微信活动操作" />
                    </td>
                </tr>
            </table>
        </div>
            ...
            <tr>
                <td>
                    <table cellspacing="0" cellpadding="3" width="100%" border="0">
                        ...
                        <tr>
                            <td class="td_class">
                                <asp:Literal ID="Literal9" runat="server" Text="抽奖限制" />：
                            </td>
                            <td height="25">
                            <asp:RadioButtonList ID="rblLimitType" runat="server" RepeatDirection="Horizontal" align="left">
                        ...
                        <tr>
                            ...
                            <td height="25">
                                <asp:TextBox ID="txtDayCount" runat="server" Width="80px" MaxLength="30"  ></asp:TextBox>
                        ...
                        <tr>
                            <td class="td_class"> 
                                <asp:Literal ID="Literal3" runat="server" Text="获奖概率" />：
                            </td>
                            <td height="25">
                                <asp:TextBox ID="txtProbability" runat="server" Width="80px" MaxLength="30"></asp:TextBox>%
                                 <span style=" color:Gray; padding-left:8px">即用户每次抽奖的中奖概率</span>
                            </td>
                        </tr>
                          <tr>
                            <td class="td_class">
                                <asp:Literal ID="Literal16" runat="server" Text="奖项类型" />：
                            </td>
                            <td height="25">
                                <asp:RadioButtonList ID="rblType" runat="server" RepeatDirection="Horizontal" align="left" Enabled="false">
                        ...
                        <tr>
                            <td class="td_class">
                                <asp:Literal ID="Literal13" runat="server" Text="活动状态" />：
                            </td>
                            <td height="25">
                            <asp:RadioButtonList ID="rblStatus" runat="server" RepeatDirection="Horizontal" align="left">
                                            ...
                                            <asp:ListItem Value="2" Text="关闭"  ></asp:ListItem>
                                        </asp:RadioButtonList>
                            </td>
                        </tr>
                        <tr>
                            <td class="td_class">
                                <asp:Literal ID="Literal7" runat="server" Text="活动图片" />：
                            </td>
                            <td height="128" >
