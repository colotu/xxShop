...
namespace YSWL.MALL.IDAL.CMS
{
	...
	public interface IVideo
	{
		...
		/// 增加一条数据
		/// </summary>
		int Add(YSWL.MALL.Model.CMS.Video model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(YSWL.MALL.Model.CMS.Video model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		YSWL.MALL.Model.CMS.Video GetModel(int VideoID);
		/// <summary>
		/// 获得数据列表
		/// </summary>
        ...
        /// 得到一个对象实体
        /// </summary>
        YSWL.MALL.Model.CMS.Video GetModelEx(int VideoID);
        #region 批量处理
        /// <summary>
        /// 批量处理
        /// </summary>
