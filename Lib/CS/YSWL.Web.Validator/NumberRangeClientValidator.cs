namespace YSWL.Web.Validator
{
    ...
    public class NumberRangeClientValidator : ClientValidator
    {
        ...
        {
            return new ValidateRenderControl { Text = string.Format(CultureInfo.InvariantCulture, "appendValid(new NumberRangeValidator('{0}', {1}, {2}, '{3}', '{4}'));", new object[] { base.Owner.TargetClientId, this.MinValue, this.MaxValue, this.ErrorMessage, base.Owner.OkMessage }) };
        }
