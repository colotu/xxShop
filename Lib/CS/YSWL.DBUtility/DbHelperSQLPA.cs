...
namespace YSWL.DBUtility
{
    ...
    /// </summary>
    public class DbHelperSQLPA : DBBase
    {
        ////数据库连接字符串(web.config来配置)		
        //public  override string GetConnectionStr() = PubConstant.GetConnectionStr();

        //public  override DbHelperSQLP()
        //{
        //}
        //public  override DbHelperSQLP(string GetConnectionStr())
        //{
        ...
        public override int ExecuteSqlTran(List<CommandInfo> list, List<CommandInfo> oracleCmdSqlList)
        {
            ...
            //        }
            //        string oraGetConnectionStr() = PubConstant.GetGetConnectionStr()("GetConnectionStr()PPC");
            //        bool res = OracleHelper.ExecuteSqlTran(oraGetConnectionStr(), oracleCmdSqlList);
            //        if (!res)
            //        {
            //            tx.Rollback();
        ...
        public object[] ExecProcedures(SqlCommand cmd)
        {
            ...
            DataSet dataSet = new DataSet();
            cmd.Connection = new SqlConnection(GetConnectionStr());
        ...
        #region 创建参数 SqlParameter CreateInParam add by jeckyong 20091204 补充扩展
        ...
        public override int ExecuteSqlTran4Indentity(List<CommandInfo> cmdList, SqlTransaction trans)
        {
            throw new NotImplementedException();
        }

        public override int ExecuteSqlTran4IndentityEx(List<CommandInfo> cmdList, SqlTransaction trans)
        {
            throw new NotImplementedException();
        }
