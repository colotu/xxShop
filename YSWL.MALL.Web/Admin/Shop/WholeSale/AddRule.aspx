<%@ Page Language="C#" Title="新增批发规则" MasterPageFile="~/Admin/BasicNoFoot.Master"
    AutoEventWireup="true" CodeBehind="AddRule.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.WholeSale.AddRule" %>
    ...
    <table id="txtTemplate" style="display: none">
        <tr>
            <td style="width: auto" class="RuleItems">
                满<span><input type="text" class="UnitValue"></span><span class="RuleUnit">个。</span>
                <span class="ItemType">按</span>
                <input type="text" class="RateValue"><span class="ItemUnit">%&#12288;计算</span>&nbsp;<span class="hy d_default"></span>
            </td>
            <td style="width: 55px;">
