<%@ Page Title="佣金商品统计"   Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
   CodeBehind="ProFeeStat.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.Commission.ProFeeStat" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal2" runat="server" Text="商品推广佣金数据统计" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal3" runat="server" Text="您可以查看商品推广佣金数据统计信息" />
                    </td>
                </tr>
            </table>
        ...
        <cc1:GridViewEx ID="gridView" runat="server" AllowPaging="true" AllowSorting="True"
            ...
            <Columns>
                <asp:TemplateField HeaderText="商品名" ItemStyle-HorizontalAlign="Left">
                    <ItemTemplate>
                       <a href="<%= YSWL.Components.MvcApplication.GetCurrentRoutePath(YSWL.Web.AreaRoute.Shop) %>product/Detail/<%# Eval("ProductId") %>" target="_blank">    <%# Eval("Name")%></a>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="用户数" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <%#(YSWL.Common.Globals.SafeInt(Eval("UserCount"), 0))%>
                    </ItemTemplate>
                </asp:TemplateField>
