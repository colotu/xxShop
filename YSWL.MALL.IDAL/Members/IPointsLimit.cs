...
namespace YSWL.MALL.IDAL.Members
{
	...
	public interface IPointsLimit
	{
        ...
        /// 增加一条数据
        /// </summary>
        int Add(YSWL.MALL.Model.Members.PointsLimit model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update(YSWL.MALL.Model.Members.PointsLimit model);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        ...
        /// 得到一个对象实体
        /// </summary>
        YSWL.MALL.Model.Members.PointsLimit GetModel(int LimitID);
        YSWL.MALL.Model.Members.PointsLimit DataRowToModel(DataRow row);
        /// <summary>
        /// 获得数据列表
        /// </summary>
