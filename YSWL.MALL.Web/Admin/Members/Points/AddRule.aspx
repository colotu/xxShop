<%@ Page Title="积分规则管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="AddRule.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Members.Points.AddRule" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal1" runat="server" Text="新增积分规则" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal6" runat="server" Text="您可以进行新增积分规则操作" />
                    </td>
                </tr>
            </table>
        </div>
                ...
                <td class="tdbg">
                    <table cellspacing="0" cellpadding="3" width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td height="25">
                                <asp:TextBox ID="tScore" TabIndex="3" runat="server" Width="250px" MaxLength="20"
                                    Text="0"></asp:TextBox>
