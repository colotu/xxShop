<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" 
Inherits="YSWL.MALL.Web.Admin.Shop.ExpressTemplate.Modify" Title="编辑快递单" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () { InitExpressName(); });
    </script>
</asp:Content>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal3" runat="server" Text="编辑快递单" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal4" runat="server" Text="您可以编辑快递单" />
                    </td>
                </tr>
            </table>
        </div>
            ...
            <div id="flashoutput">
                <noscript>
                    <object id="flexApp" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,5,0,0" height="600" width="900">
                        ...
                        <param name="src" value="/Tools/flex/EditExpressTemplate.swf" />
                        <embed name="flexApp" pluginspage="http://www.macromedia.com/go/getflashplayer" src="/Tools/flex/EditExpressTemplate.swf" height="600" width="900" flashvars="bridgeName=example" />
                    </object>
                </noscript>
                <script language="javascript" charset="utf-8">
                    ...
                    document.write('<param name="src" value="/Tools/flex/EditExpressTemplate.swf"/>');
                    document.write('<embed name="flexApp" pluginspage="http://www.macromedia.com/go/getflashplayer" src="/Tools/flex/EditExpressTemplate.swf" height="600" width="900" flashvars="bridgeName=example"/>');
