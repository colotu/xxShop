...
using YSWL.OAuth.Util;

namespace YSWL.OAuth.IO
{
    /// <summary>
    /// An <see cref="YSWL.OAuth.IO.IResource"/> implementation for resources stored within assemblies 
    ...
    /// <seealso cref="YSWL.OAuth.IO.IResource"/>
    public class AssemblyResource : AbstractResource
    {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="YSWL.OAuth.IO.AssemblyResource"/> class 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="YSWL.OAuth.IO.AssemblyResource"/> class. 
        /// </summary>
        /// <param name="fileName">The name of the file in the assembly.</param>
        ...
        /// </returns>
        /// <seealso cref="YSWL.OAuth.IO.IResource.IsOpen"/>
        public override Stream GetStream()
        {
            ...
            {
                throw new FileNotFoundException(String.Format(
                    "Could not load resource [{0}] from assembly [{1}]. YSWL.OAuth.NET URI syntax is 'assembly://MyAssembly/MyNamespace/MyResource.ext'", this.resourceName, this.assembly));
            }
            return stream;
        }
