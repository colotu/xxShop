...
using YSWL.ZipLib.Encryption;
#endif

using YSWL.ZipLib.Core;
using YSWL.ZipLib.Checksums;
using YSWL.ZipLib.Zip.Compression.Streams;
using YSWL.ZipLib.Zip.Compression;

namespace YSWL.ZipLib.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="YSWL.ZipLib.Zip.ZipException">
