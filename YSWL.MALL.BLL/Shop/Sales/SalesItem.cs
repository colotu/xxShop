...
namespace YSWL.MALL.BLL.Shop.Sales
{
	...
	public partial class SalesItem
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.Shop.Sales.SalesItem GetModelByCache(int ItemId)
		{
			...
			return (YSWL.MALL.Model.Shop.Sales.SalesItem)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Sales.SalesItem> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Sales.SalesItem> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.Shop.Sales.SalesItem> modelList = new List<YSWL.MALL.Model.Shop.Sales.SalesItem>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.Shop.Sales.SalesItem model;
        ...
        {
            return dal.GetLowesSales(ruleId);
        }
