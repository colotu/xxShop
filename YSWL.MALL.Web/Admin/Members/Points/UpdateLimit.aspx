<%@ Page Title="积分限制管理" Language="C#" MasterPageFile="~/Admin/Basic.Master"
    AutoEventWireup="true"  CodeBehind="UpdateLimit.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Members.Points.UpdateLimit" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                         <asp:Literal ID="Literal1" runat="server" Text="修改积分限制" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                         <asp:Literal ID="Literal6" runat="server" Text="您可以进行修改积分限制操作" />
                    </td>
                </tr>
            </table>
        </div>
