...
namespace YSWL.MALL.BLL.Shop.Inquiry
{
	...
	public partial class InquiryInfo
	{
		...
		{
			return dal.DeleteList(Common.Globals.SafeLongFilter(InquiryIdlist ,0) );
		}
		...
		public YSWL.MALL.Model.Shop.Inquiry.InquiryInfo GetModel(long InquiryId)
		{
			...
			return dal.GetModel(InquiryId);
		}

		/// <summary>
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.Shop.Inquiry.InquiryInfo GetModelByCache(long InquiryId)
		{
			...
			if (objModel == null)
			{
				try
				{
					objModel = dal.GetModel(InquiryId);
					if (objModel != null)
					{
			...
			return (YSWL.MALL.Model.Shop.Inquiry.InquiryInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Inquiry.InquiryInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Inquiry.InquiryInfo> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.Shop.Inquiry.InquiryInfo> modelList = new List<YSWL.MALL.Model.Shop.Inquiry.InquiryInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.Shop.Inquiry.InquiryInfo model;
