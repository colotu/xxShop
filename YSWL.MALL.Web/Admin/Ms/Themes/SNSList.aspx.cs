...
{
    public partial class SNSList : PageBaseAdmin
    {
        ...
        {
            //获取该主区域 下的所有模板
            List<YSWL.MALL.Model.Ms.Theme> themeList = YSWL.MALL.Web.Components.FileHelper.GetThemes("SNS");
            //获取当前主模板
            string name = YSWL.MALL.BLL.SysManage.ConfigSystem.GetValueByCache("SNS_Theme");
        ...
        protected void DataListPhoto_ItemCommand(object source, DataListCommandEventArgs e)
        {
            if (e.CommandName == "start")
            {
                if (e.CommandArgument != null)
                {
                    ...
                    //写
                    YSWL.MALL.BLL.SysManage.ConfigSystem.Modify("SNS_Theme", name, "社区模板的名称");
                    Cache.Remove("ConfigSystemHashList");    //清除网站设置的缓存文件
                    MessageBox.ShowSuccessTip(this, "启用成功", "SNSList.aspx");
                }
            }
        }
