...
namespace YSWL.MALL.BLL.Shop.Activity
{
	...
	{
		private readonly IActivityDetail dal=DAShopActivity.CreateActivityDetail();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.Shop.Activity.ActivityDetail GetModelByCache(long DetailId)
		{
			...
			return (YSWL.MALL.Model.Shop.Activity.ActivityDetail)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Activity.ActivityDetail> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Activity.ActivityDetail> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.Shop.Activity.ActivityDetail> modelList = new List<YSWL.MALL.Model.Shop.Activity.ActivityDetail>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.Shop.Activity.ActivityDetail model;
