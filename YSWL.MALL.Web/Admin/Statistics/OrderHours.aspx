<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderHours.aspx.cs" Inherits="YSWL.Web.Admin.Statistics.OrderHours" %>

<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true" CodeBehind="OrderHours.aspx.cs" Inherits="YSWL.Web.Admin.Statistics.OrderHours" %>
<%@ Register TagPrefix="cc1" Namespace="YSWL.Web.Controls" Assembly="YSWL.Web" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#orderCount').highcharts({
                ...
                tooltip: {
                    formatter: function () {
                        return '<b>' + this.series.name + '</b><br/>  ' + this.y + '件';
                    }
                },
                plotOptions: {
                    line: {
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                ...
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal2" runat="server" Text="您可以查看销量和销售额统计信息" />
                    </td>
                </tr>
            </table>
                ...
                <td width="800px">
                    <cc1:GridViewEx ID="gridView" runat="server" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="业绩 " ItemStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                    <%#Eval("ToalPrice") == null ? "0.00" : Convert.ToDecimal(Eval("ToalPrice").ToString()).ToString("F")%></ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
