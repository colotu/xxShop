...
namespace YSWL.Payment.PaymentInterface.Alipay
{
    ...
    internal class StandardRequest : PaymentRequest
    {
        ...
        private string receive_name = "SHIPNAMEISNULL";
        ...
        public StandardRequest(PayeeInfo payee, GatewayInfo gateway, TradeInfo trade)
        {
            ...
            this.receive_name = string.IsNullOrWhiteSpace(trade.BuyerName) ? "BUYERNAMEISNULL" : trade.BuyerName;
            this.receive_address = trade.BuyerAddress;
            this.receive_phone = trade.BuyerPhone;
            this.receive_mobile = trade.BuyerMobile;
        }

        public override void SendRequest()
        {
            this.RedirectToGateway(Globals.CreatUrl(this.gateway, this.service, this.partner, this.sign_type,
                this.out_trade_no, this.subject, this.body, this.payment_type, this.price, this.show_url,
                this.seller_email, this.key, this.return_url, this._input_charset, this.notify_url,
                this.receive_name, this.receive_address, this.receive_phone, this.receive_mobile,
