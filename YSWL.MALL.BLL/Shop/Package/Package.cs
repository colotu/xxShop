...
namespace YSWL.MALL.BLL.Shop.Package
{
	...
	public partial class Package
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.Shop.Package.Package GetModelByCache(int PackageId)
		{
			...
			return (YSWL.MALL.Model.Shop.Package.Package)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Package.Package> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.Shop.Package.Package> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.Shop.Package.Package> modelList = new List<YSWL.MALL.Model.Shop.Package.Package>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.Shop.Package.Package model;
